...
insert into transactions (desired_currency, total_money, current_currency, transaction_location, exchange_rate, fees, total_charges, transaction, createdAt, updatedAt)
values ('USD', 200, 'Euros', 'Newark Liberty International Airport', 3.5, 10, 510, false, current_timestamp, current_timestamp);
insert into transactions (desired_currency, total_money, current_currency, transaction_location, exchange_rate, fees, total_charges, transaction, createdAt, updatedAt)
values ('USD', 700, 'Euros', 'Newark Liberty International Airport', 3.5, 10, 510, false, current_timestamp, current_timestamp);
insert into transactions (desired_currency, total_money, current_currency, transaction_location, exchange_rate, fees, total_charges, transaction, createdAt, updatedAt)
values ('USD', 100, 'Euros', 'JFK International Airport', 3.5, 10, 510, false, current_timestamp, current_timestamp);
insert into transactions (desired_currency, total_money, current_currency, transaction_location, exchange_rate, fees, total_charges, transaction, createdAt, updatedAt)
values ('USD', 500, 'Euros', 'JFK International Airport', 3.5, 10, 510, false, current_timestamp, current_timestamp);