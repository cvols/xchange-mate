-- user seeds --
insert into users (first_name, last_name, username, password, email, phone_number, street_address, city, state, zip_code, user_rating, transaction, createdAt, updatedAt)
...
-- transactions seeds --
insert into transactions (desired_currency, total_money, current_currency, transaction_location, exchange_rate, fees, total_charges, transaction, createdAt, updatedAt, UserId, VendorId)
